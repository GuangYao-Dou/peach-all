 ...
 */
package cn.odboy.modules.security.config.bean;


import cn.odboy.exception.BadConfigurationException;
        ...
        synchronized (this) {
            switch (loginCode.getCodeType()) {
                ...
                case spec:
                    ...
                    break;
                default:
                    throw new BadConfigurationException("验证码配置信息错误！！！正确配置查看 cn.odboy.modules.security.config.bean.LoginCodeEnum ");
            }
        }
        return captcha;
    }
